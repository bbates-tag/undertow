...
import {
  ...
  GiFangsCircle, GiFirstAidKit, GiFishCorpse, GiFishEscape, GiFishMonster, GiFishScales,
  ...
  GiSuckeredTentacle, GiSunkenEye, GiSwamp, GiTentacleHeart, GiTentaclesSkull, GiTentacurl,
...
export const STATUS_META: Record<string, { icon: string; color: string; name: string }> = {
  ...
  weakened: { icon: 'GiFishEscape', color: 'var(--color-mist)', name: 'Weakened' },
